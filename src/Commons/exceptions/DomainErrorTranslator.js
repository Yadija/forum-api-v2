...
DomainErrorTranslator._directories = {
  ...
  'NEW_THREAD.THREAD_TITLE_LIMIT_CHAR': new InvariantError('tidak dapat membuat user baru karena karakter title thread melebihi batas limit'),
  'DETAIL_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak mendapatkan thread karena properti yang dibutuhkan tidak ada'),
  'DETAIL_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan thread karena tipe data tidak sesuai'),
  ...
  'DETAIL_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak mendapatkan comment karena properti yang dibutuhkan tidak ada'),
  'DETAIL_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan comment karena tipe data tidak sesuai'),
  ...
  'DETAIL_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak mendapatkan reply karena properti yang dibutuhkan tidak ada'),
  'DETAIL_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mendapatkan reply karena tipe data tidak sesuai'),
